                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        class="card border-0 rounded-3 shadow border-top-warning">
                            ...
                            <div class="card-body">
                                <DoughnutChart :chartData="chartBestProduct"></DoughnutChart>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div v-if="hasAnyPermission(['dashboard.product_stock'])"
                        class="card border-0 rounded-3 shadow border-top-danger mb-4">
                            <div class="card-header">
                                <span class="font-weight-bold">
                                    <i class="fa fa-chart-line"></i> PRODUCT STOCK
                                </span>
                            </div>
                            <div class="card-body">
                                <div v-if="products_limit_stock.length > 0">
                                    <ol class="list-group list-group-numbered">
                                        ...
                                        class="list-group-item d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="badgebg-danger rounded-pill">
                                                {{ product.stock }}
                                            </span>
                                        </li>
                                    </ol>
...
export default {
    ...
    props: {
        ...
        //jumlah laba hari ini
        sum_profits_today: Number,

        //chart sales for a week
        sales_date: Array,
        grand_total: Array,
